...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Great news! Your booking request with <strong>{{ $worker_name }}</strong> has been <span class="status-approved">APPROVED</span>!</p>
            ...
            <p>You can view your booking details and track the service status by logging into your account.</p>
